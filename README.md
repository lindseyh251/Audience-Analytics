...
- **Who is engaging** — reader segmentation by engagement depth
- **When they engage** — hourly and weekday patterns for publish timing strategy
- **What they click** — content category and headline structure performance
- **What it means** — plain-language editorial recommendations drawn from the data

## Tools & Methods
- R, ggplot2, R Markdown
- Session-level engagement segmentation
- CTR analysis by content category and headline structure
